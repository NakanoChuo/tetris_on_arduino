...
byte read_button_input(void);         // ボタンの押下状態を返す
bool button_press(byte button_code);  // ボタンを押しているかどうか
bool button_down(byte button_code);   // ボタンを押した瞬間かどうか
bool button_up(byte button_code);     // ボタンを離した瞬間かどうか
